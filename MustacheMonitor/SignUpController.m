...
@synthesize FirstName, LastName, Email, Username, Password, ReenterPassword;
...
- (IBAction)SignUpTapped:(id)sender {
    ...
    NSString *_urlString = @"http://mustachemonitor.com/user/create";
    ...
    //bodyString += [NSString stringWithFormat:@"firstName=%@&",self.FirstName.text];
    
    [body appendData:[[NSString stringWithFormat:@"firstName=nick&lastName=walter&email=n@n.com&screenName=myname&password=1234567&passwordConfirmation=1234567"] dataUsingEncoding:NSUTF8StringEncoding]];
